            ...
            <div className="mt-2.5 flex flex-col gap-4">
              {!imagePreview ? (
                ...
                <div className="relative flex flex-col items-center justify-center rounded-2xl border border-slate-200 p-4 dark:border-slate-800">
                  <img
                    src={imagePreview.startsWith('/') ? (window.location.port === '5173' ? `http://localhost:5000${imagePreview}` : (window.location.hostname.includes('vercel.app') ? `https://ccms-backend-eight.vercel.app${imagePreview}` : imagePreview)) : imagePreview}
                    alt="Upload Preview"
